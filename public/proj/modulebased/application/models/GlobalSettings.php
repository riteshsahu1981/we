 ...
 * @uses       Application_Model_GlobalSettings
 * @package    Default
 * @subpackage Model
 */
...
class Application_Model_GlobalSettings {
    ...
    /**
     * @var Application_Model_GlobalSettingsMapper
     */
     ...
     * Get data mapper
     *
     * Lazy loads Application_Model_GlobalSettingsMapper instance if no mapper registered.
     * 
     * @return Application_Model_GlobalSettings
     */
    public function getMapper()
    {
        if (null === $this->_mapper) {
            $this->setMapper(new Application_Model_GlobalSettingsMapper());
        }
        return $this->_mapper;
    }
