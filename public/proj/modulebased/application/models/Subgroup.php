<?php
class Application_Model_Subgroup {
    ...
    public function getMapper()
    {
        if (null === $this->_mapper) {
            $this->setMapper(new Application_Model_SubgroupMapper());
        }
        return $this->_mapper;
    }
  ...
  public function getCreatedBy()
    ...
    public function save()
    {
        ...
        if (null === ($id = $this->getId())) {
            unset($data['id']);
            $data['addedon']=time(); $data['created_by']=$usersNs-userId;
 ...
 /*------Data utility functions------*/
    public function getSubgroup($type=null)
    {
        $obj=new Application_Model_Subgroup();
