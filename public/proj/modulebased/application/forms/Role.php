   ...
   public $elementDecorators = array(
    ...
    public function init()
    {
        $this->setName('frmRole');
            ...
            'required'   => true,
            'validators' => array(
            array('NotEmpty', true, array('messages'=>array('isEmpty'=>'You must enter Identifier'))),
            array('Db_NoRecordExists', true, array(
            'table' => 'user_role',
            'field' => 'identifire',
            'messages'=>'Role already exists'
            ))
            ),
	   ...
	   $this->addElement('text', 'role', array(
            ...
            'required'   => true,
            'validators' => array(
            array('NotEmpty', true, array('messages'=>array('isEmpty'=>'You must enter Role'))),
            array('Db_NoRecordExists', true, array(
            'table' => 'user_role',
            'field' => 'role',
            'messages'=>'Role already exists'
