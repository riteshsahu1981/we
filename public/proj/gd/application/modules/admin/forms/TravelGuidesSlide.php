<?php
class Admin_Form_TravelGuidesSlide extends Zend_Form
{
    ...
    {            
	   ...
	   $this->addElement('file', 'slideImage', array(
            'label'      => 'Slide Image:',
            'required'   => false,
         	'validators' => array(
		...
		$this->getElement('slideImage')->addValidator('Size', false, 1024*1024*2); //2 MB file is allowed
		$this->getElement('slideImage')->getValidator('Size')->setMessages(array("fileSizeTooBig"=>"Maximum allowed file size is 2 MB.","fileSizeTooSmall"=>""));
		$this->getElement('slideImage')->addValidator('Extension', false, 'jpg,jpeg,png,gif');
		$this->getElement('slideImage')->getValidator('Extension')->setMessages(array("fileExtensionFalse"=>"Please upload jpg,jpeg,png,gif file.","fileExtensionNotFound"=>""));
