        	...
        	'required'   => true,
         	'validators' => array(
                	array('NotEmpty', true, array('messages'=>array('isEmpty'=>'Please enter the email address'))),
                       array('EmailAddress', false, array('messages'=>array('emailAddressInvalidFormat'=>'Please enter valid email address'))),
                	array('Db_NoRecordExists', true, array(
        			'table' => 'user',
	       			'field' => 'email',
	       			'messages'=>'Email already exists'
...
$this->addElement('hidden', 'gapperOrFriend', array(
            'label'      => 'Are you a Traveller or a friend of a Traveller or a Family Member?',
        	'class' =>'form',
        	'decorators' => $this->elementDecorators,
            'required'   => false,
...
//  		));
 ...
 $this->addElement('hidden', 'firstTimeTraveller', array(
            'label'      => 'First time traveller?',
        	'class' =>'form',
        	'decorators' => $this->elementDecorators,
            'required'   => false,
	...
	/* $TermsCondition	=	new Zend_Form_Element_Checkbox('termsCondition');
      ...
      $this->addElement('submit', 'submit', array(
		...
		$this->getElement('email')->addValidator('Badwords', true);
		$this->getElement('username')->addValidator('Badwords', true);
		$this->getElement('firstName')->addValidator('Badwords', true);
		$this->getElement('lastName')->addValidator('Badwords', true);
	}
