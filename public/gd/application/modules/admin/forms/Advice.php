 ...
 * @subpackage Form
 */
class Admin_Form_Advice extends Zend_Form
{
    /**
    ...
    public function init()
    {
        ...
        $this->addElement('select', 'categoryId',array(
        	...
        	'required'   => true,
        	'validators' => array(
                	array('NotEmpty', true, array('messages'=>array('isEmpty'=>'Please select advice category.')))
            	),
        	'decorators' => $this->elementDecorators,
            'filters'    => array('StringTrim'),
	   ...
	   $this->addElement('text', 'title', array(
            ...
            'required'   	=> true,
         	'validators' 	=> array(
  						  		array('NotEmpty', true, array('messages'=>array('isEmpty'=>'You must enter the advice title')))
   							),
        	'decorators' => $this->elementDecorators,
        ));
        ...
        $this->addElement('text', 'identifire', array(
            ...
            'required'   => true,
         	'validators' => array(
  						  		array('NotEmpty', true, array('messages'=>array('isEmpty'=>'You must enter the advice URL Re-write')))
   							),
        	'decorators' => $this->elementDecorators,
        ));
