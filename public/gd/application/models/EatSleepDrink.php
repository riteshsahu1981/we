<?php
class Application_Model_EatSleepDrink{

    protected $_id;
    protected $_title;
    protected $_backPackerCopy;
    protected $_localCopy;
    ...
    public function getMapper()
    {
        if (null === $this->_mapper) {
            $this->setMapper(new Application_Model_EatSleepDrinkMapper());
        }
        return $this->_mapper;
    }
	...
	public function setBackPackerCopy($backPackerCopy)
    {
        $this->_backPackerCopy= (string) $backPackerCopy;
        return $this;
    }

    public function getBackPackerCopy()
    {
        return $this->_backPackerCopy;
    }
...
public function setLocalCopy($localCopy)
    {
        $this->_localCopy= (string) $localCopy;
        return $this;
    }
    ...
    private function setModel($row)
    {
            ...
            $model->setId($row->id)
                  	->setTitle($row->title)
                	->setBackPackerCopy($row->back_packer_copy)
                	->setlocalCopy($row->local_copy)
    ...
    $data = array(
            'title' => $this->getTitle(),
    		'back_packer_copy' => $this->getBackPackerCopy(),
