		...
		foreach ($rels->Relationship as $rel) {
			...
			switch ($rel["Type"]) {
				...
				case "http://schemas.openxmlformats.org/package/2006/relationships/metadata/core-properties":
							$contentzip=$this->_getFromZipArchive($zip, "{$rel['Target']}");
					$xmlCore = simplexml_load_string($contentzip);
					
			var_dump($xmlCore->xpath("dc:title"));
			
				//	if ($xmlCore==!false) {
					//		die("I am on ".__LINE__." at ".__FILE__);
