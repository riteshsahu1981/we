...
class Base_Facebook_Facebook
{
   ...
   * @throws Base_Facebook_FacebookApiException
   */
  protected function _restserver($params) {
    ...
    if (is_array($result) && isset($result['error_code'])) {
      throw new Base_Facebook_FacebookApiException($result);
    }
    return $result;
  }
  ...
  protected function _graph($path, $method='GET', $params=array()) {
    ...
    if (is_array($result) && isset($result['error'])) {
      $e = new Base_Facebook_FacebookApiException($result);
  ...
  protected function makeRequest($url, $params, $ch=null) {
    ...
    $result = curl_exec($ch);
    if ($result === false) {
      $e = new Base_Facebook_FacebookApiException(array(
