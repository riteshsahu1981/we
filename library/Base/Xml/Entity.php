 ...
 */
public function unicode_ord(&$c, &$i = 0) {
 ...
 */
public function xmlentities($s, $hex = true) {
 ...
 * @author Dom Hastings
 */
public function xml_entity_decode($s, $entities = array()) {
