<?php
//This validator is used to validate alphanumeric characters which allow some special characters as well
 ...
 */
class Base_Validate_Alphachar extends Zend_Validate_Abstract
{
    const INVALID      = 'alnumInvalid';
    const NOT_ALNUM    = 'notAlnum';
    const STRING_EMPTY = 'alnumStringEmpty';
    const NOT_VALID    = 'alnumStringNotValid';
    ...
    protected $_messageTemplates = array(
        ...
        self::NOT_VALID    => "Special characters are not allowed",
    );
